    ...
    for i, (f, n, m, args) in enumerate(d['backbone'] + d['head']):  # from, number, module, args
        ...
        if m in (Classify, Conv, ConvTranspose, GhostConv, Bottleneck, GhostBottleneck, SPP, SPPF, DWConv, DSConv, Focus,
            ...
            if m in (BottleneckCSP, C1, C2, C2f, C3, C3TR, C3Ghost, C3x, RepC3, DWRC3, C3_DWR, C2f_DWR, C3_DCNv2_Dynamic, C2f_DCNv2_Dynamic,
                ...
                n = 1
        elif m in (StokenAttention,SHSA,DoubleAttention,AIFI, AIFI_LPE, TransformerEncoderLayer_LocalWindowAttention, TransformerEncoderLayer_DAttention, TransformerEncoderLayer_HiLo, TransformerEncoderLayer_EfficientAdditiveAttnetion):
            args = [ch[f], *args]
        elif m is TselfATTENTION:
            c2= ch[f]
            # c2 = c1
            args = [c2]
        elif m is EUCB:
            ...
            c2 = args[0]
            args = [c1, *args]
        elif m is DynamicResidualTransfer:
            c1 = ch[f]
            c2 = args[0]
            # planes = 64
            args = [c1, c2 // 4]
        # elif m is TokenSelect:
        #     c2 = ch[f]
        #     args = [c2, *args]
            ...
            c2 = m.channel
                   ...
                   # CBAM,
                   BAMBlock, LSKBlock, SEAttention, CPCA, EfficientAttention,
        ...
        elif m in{Partial_conv3,
                  DynamicPartialDownsample,
                  InceptionDWConv2d,
                  Partial_conv3_DWCWTC,
