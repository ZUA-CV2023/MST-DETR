...
parser.add_argument('--image_path', default='D:/Datasets/coco/val2017',type=str, help="path of images")
parser.add_argument('--label_path', default='"D:/Datasets/coco/annotations/instances_val2017.json"',type=str, help="path of labels .txt")
